...
- Mode test : python puzzle_game_gui.py --test

Ajout : système d'auto-mise-à-jour LAN (vérification, téléchargement, vérification SHA256,
...
# New imports for update feature (stdlib only)
